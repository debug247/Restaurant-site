...
const Items = () => {
    ...
    return (
        <section id='menu' className="w-full h-fit bg-slate-950 px-12 lg:px-20 lg:py-24 py-20 flex flex-col justify-center items-center gap-10">
            <h1 data-aos="zoom-in" className="text-white font-bold text-6xl text-center">View Our Tasty <span className="text-limegreen italic">Foods</span></h1>
            ...
            >
                <div data-aos="slide-up" data-aos-delay="200" className="flex flex-col justify-center items-center gap-4 bg-slate-900 pb-10 lg:w-2/5 w-full rounded-[150px]">
                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-4 px-10">
                        ...
                        <button className=" bg-limegreen px-8 py-4 rounded-full hover:bg-orange-500 hover:text-black font-bold mt-2">
                            ORDER NOW
                        </button>
                    </div>
                </div>
                <div data-aos="slide-up" data-aos-delay="400" className="flex flex-col justify-center items-center gap-4 bg-slate-900 pb-10 lg:w-2/5 w-full rounded-[150px]">
                    <img src={dish2} alt="" />
                    <div className="w-full flex flex-col justify-center items-center gap-4 px-10">
                        <h1 className="text-white font-bold text-2xl">STUFFED TASTY BURGER</h1>
                        <p className="text-white font-semibold text-lg text-center">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque,
                            porro?
                        </p>
                ...
                <div data-aos="slide-up" data-aos-delay="200" className="flex flex-col justify-center items-center gap-4 bg-slate-900 pb-10 lg:w-2/5 w-full rounded-[150px]">
                    <img src={dish3} alt="" />
                    <div className="w-full flex flex-col justify-center items-center gap-4 px-10">
                        <h1 className="text-white font-bold text-2xl">HOT PIZZA</h1>
                        <p className="text-white font-semibold text-lg text-center">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque,
                            porro?
                        </p>
